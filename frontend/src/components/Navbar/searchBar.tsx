...
const SearchBar: React.FC = () => {
  return (
    <div className="font-heading relative flex h-11 w-[80%] items-center justify-center font-extralight transition-transform duration-300 hover:scale-101">
      <input type="text" name="search" id="search" placeholder="Search for artist,song or dreamy vibes..." 
      className="flex h-full w-full rounded-4xl border border-neutral-200 py-2 pl-12 
      tracking-widest  caret-neutral-400  
      backdrop-blur-md placeholder:text-sm placeholder:text-neutral-400 
      focus:ring-[0.5px] focus:outline-none focus:ring-accentText text-primaryText
      bg-linear-to-r from-[#fdf6ff] from-0% to-[#f4ffff]" />
